...
import { SIZES } from '@/shared/types/pet.types'
import { Button } from '@/shared/ui/button'
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/shared/ui/dialog'
import { Input } from '@/shared/ui/input'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/shared/ui/select'
import { Pet, PetSize } from '@monorepo/functions/src/types/reservations'
            ...
            <DialogContent className='max-h-[90vh] w-[95vw] max-w-[500px] p-0'>
                <form onSubmit={handleSubmit} className='flex h-full max-h-[90vh] flex-col'>
                    <DialogHeader className='shrink-0 border-b px-4 py-2'>
                        <DialogTitle className='text-base font-medium'>{t('editPet')}</DialogTitle>
                    </DialogHeader>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={e =>
                                            setEditedPet(prev => ({ ...prev, weight: parseFloat(e.target.value) }))
                                        }
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value: 'yes' | 'no') =>
                                        setEditedPet(prev => ({ ...prev, isNeutered: value === 'yes' }))
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue />
